...
HD_PWD='C:/Users/Serena/Desktop/image_analyser_synt/project_final_1/project_final_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log file_reader.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source file_reader.tcl
